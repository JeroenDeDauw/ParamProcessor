...
# Validator_ERRORS_NONE  : Validator will not show any errors, and make the best of the imput it got.
# Validator_ERRORS_WARN  : Validator will make the best of the imput it got, but will show a warning that there are errors.
# Validator_ERRORS_SHOW  : Validator will make the best of the imput it got, but will show a list of all errors.
