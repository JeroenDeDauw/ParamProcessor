...
$messages['cs'] = array(
	...
	'validator-list-error-accepts-only' => 'Jedna či více hodnot parametru $1 jsou neplatné. {{{{PLURAL:$3|Platná je pouze tato hodnota|Platné jsou pouze tyto hodnoty}}: $2.', # Fuzzy
	...
	'validator-error-accepts-only-omitted' => 'Hodnota "$2" není pro parametr $1 platná. {{PLURAL:$3|Platná je pouze tato hodnota|Platné jsou pouze tyto hodnoty}}: $2 (a $4 {{PLURAL:$4|vynechaná hodnota|vynechané hodnoty}}).', # Fuzzy
